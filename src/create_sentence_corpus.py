...
def main(input_path, output_path):
    ...
    document_ids = [[doc_id]*n_sents for doc_id, n_sents
                     in zip(document_corpus.document_id, n_sentences)]
    ...
    sentence_corpus_columns = ['global_sentence_id','document_id', 'sentence_id', 'sentence']
    sentence_corpus = pd.DataFrame(sentence_corpus_dict, columns=sentence_corpus_columns)
